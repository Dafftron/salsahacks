 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hn{constructor(){this.providerId=Hn.PROVIDER_ID}static credential(e,t){return qn._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=Kn.parseLink(t);return Et(n,"argument-error"),qn._fromEmailAndCode(e,n.code,n.tenantId)}}Hn.PROVIDER_ID="password",Hn.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Hn.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ss(e){return l(this,null,function*(){if(e.code!==Zi.FAILED_PRECONDITION||"The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab."!==e.message)throw e;Hi("LocalStore","Unexpectedly lost primary lease")})}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class js{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(e){try{return atob(e)}catch(t){throw"undefined"!=typeof DOMException&&t instanceof DOMException?new Bs("Invalid base64 string: "+t):t}}(e);return new js(t)}static fromUint8Array(e){const t=function(e){let t="";for(let n=0;n<e.length;++n)t+=String.fromCharCode(e[n]);return t}(e);return new js(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return e=this.binaryString,btoa(e);var e}toUint8Array(){return function(e){const t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return ds(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}js.EMPTY_BYTE_STRING=new js("");const qs=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function zs(e){if(Ji(!!e),"string"==typeof e){let t=0;const n=qs.exec(e);if(Ji(!!n),n[1]){let e=n[1];e=(e+"000000000").substr(0,9),t=Number(e)}const r=new Date(e);return{seconds:Math.floor(r.getTime()/1e3),nanos:t}}return{seconds:$s(e.seconds),nanos:$s(e.nanos)}}function $s(e){return"number"==typeof e?e:"string"==typeof e?Number(e):0}function Ks(e){return"string"==typeof e?js.fromBase64String(e):js.fromUint8Array(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hs(e){var t,n;return"server_timestamp"===(null===(n=((null===(t=null==e?void 0:e.mapValue)||void 0===t?void 0:t.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function Gs(e){const t=e.mapValue.fields.__previous_value__;return Hs(t)?Gs(t):t}function Ws(e){const t=zs(e.mapValue.fields.__local_write_time__.timestampValue);return new ps(t.seconds,t.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hu{constructor(e){this.ct=e}}function Gu(e){const t=xu({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?Xo(t,t.limit,"L"):t}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pc{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=C()?8:function(e){const t=e.match(/Android ([\d.]+)/i),n=t?t[1].split(".").slice(0,2).join("."):"-1";return Number(n)}(S())>0?6:4}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,n,r){const i={result:null};return this.Yi(e,t).next(e=>{i.result=e}).next(()=>{if(!i.result)return this.Zi(e,t,r,n).next(e=>{i.result=e})}).next(()=>{if(i.result)return;const n=new fc;return this.Xi(e,t,n).next(r=>{if(i.result=r,this.zi)return this.es(e,t,n,r.size)})}).next(()=>i.result)}es(e,t,n,r){return n.documentReadCount<this.ji?(Ki()<=q.DEBUG&&Hi("QueryEngine","SDK will not create cache indexes for query:",Zo(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),Cs.resolve()):(Ki()<=q.DEBUG&&Hi("QueryEngine","Query:",Zo(t),"scans",n.documentReadCount,"local documents and returns",r,"documents as results."),n.documentReadCount>this.Hi*r?(Ki()<=q.DEBUG&&Hi("QueryEngine","The SDK decides to create cache indexes for query:",Zo(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Wo(t))):Cs.resolve())}Yi(e,t){if(Ko(t))return Cs.resolve(null);let n=Wo(t);return this.indexManager.getIndexType(e,n).next(r=>0===r?null:(null!==t.limit&&1===r&&(t=Xo(t,null,"F"),n=Wo(t)),this.indexManager.getDocumentsMatchingTarget(e,n).next(r=>{const i=pa(...r);return this.Ji.getDocuments(e,i).next(r=>this.indexManager.getMinOffset(e,n).next(n=>{const s=this.ts(t,r);return this.ns(t,s,i,n.readTime)?this.Yi(e,Xo(t,null,"F")):this.rs(e,s,t,n)}))})))}Zi(e,t,n,r){return Ko(t)||r.isEqual(gs.min())?Cs.resolve(null):this.Ji.getDocuments(e,n).next(i=>{const s=this.ts(t,i);return this.ns(t,s,n,r)?Cs.resolve(null):(Ki()<=q.DEBUG&&Hi("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),Zo(t)),this.rs(e,s,t,function(e,t){const n=e.toTimestamp().seconds,r=e.toTimestamp().nanoseconds+1,i=gs.fromTimestamp(1e9===r?new ps(n+1,0):new ps(n,r));return new bs(i,ws.empty(),t)}(r,-1)).next(e=>e))})}ts(e,t){let n=new Us(ta(e));return t.forEach((t,r)=>{ea(e,r)&&(n=n.add(r))}),n}ns(e,t,n,r){if(null===e.limit)return!1;if(n.size!==t.size)return!0;const i="F"===e.limitType?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Xi(e,t,n){return Ki()<=q.DEBUG&&Hi("QueryEngine","Using full collection scan to execute query:",Zo(t)),this.Ji.getDocumentsMatchingQuery(e,t,bs.min(),n)}rs(e,t,n,r){return this.Ji.getDocumentsMatchingQuery(e,n,r).next(e=>(t.forEach(t=>{e=e.insert(t.key,t)}),e))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sc{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){Hi("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.ho)e(0)}lo(){Hi("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.ho)e(1)}static D(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nc="WebChannelConnection";class Oc extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.Do=t+"://"+e.host,this.vo=`projects/${n}/databases/${r}`,this.Co="(default)"===this.databaseId.database?`project_id=${n}`:`project_id=${n}&database_id=${r}`}get Fo(){return!1}Mo(e,t,n,r,i){const s=kc(),o=this.xo(e,t.toUriEncodedString());Hi("RestConnection",`Sending RPC '${e}' ${s}:`,o,n);const a={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(a,r,i),this.No(e,o,a,n).then(t=>(Hi("RestConnection",`Received RPC '${e}' ${s}: `,t),t),t=>{throw Wi("RestConnection",`RPC '${e}' ${s} failed with error: `,t,"url: ",o,"request:",n),t})}Lo(e,t,n,r,i,s){return this.Mo(e,t,n,r,i)}Oo(e,t,n){e["X-Goog-Api-Client"]="gl-js/ fire/"+zi,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,n)=>e[n]=t),n&&n.headers.forEach((t,n)=>e[n]=t)}xo(e,t){const n=Ac[e];return`${this.Do}/v1/${t}:${n}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,n,r){const i=kc();return new Promise((s,o)=>{const a=new Di;a.setWithCredentials(!0),a.listenOnce(Li.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case xi.NO_ERROR:const t=a.getResponseJson();Hi(Nc,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case xi.TIMEOUT:Hi(Nc,`RPC '${e}' ${i} timed out`),o(new es(Zi.DEADLINE_EXCEEDED,"Request time out"));break;case xi.HTTP_ERROR:const n=a.getStatus();if(Hi(Nc,`RPC '${e}' ${i} failed with status:`,n,"response text:",a.getResponseText()),n>0){let e=a.getResponseJson();Array.isArray(e)&&(e=e[0]);const t=null==e?void 0:e.error;if(t&&t.status&&t.message){const e=function(e){const t=e.toLowerCase().replace(/_/g,"-");return Object.values(Zi).indexOf(t)>=0?t:Zi.UNKNOWN}(t.status);o(new es(e,t.message))}else o(new es(Zi.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new es(Zi.UNAVAILABLE,"Connection failed."));break;default:Xi()}}finally{Hi(Nc,`RPC '${e}' ${i} completed.`)}});const u=JSON.stringify(r);Hi(Nc,`RPC '${e}' ${i} sending request:`,r),a.send(t,"POST",u,n,15)})}Bo(e,t,n){const r=kc(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],s=Vi(),o=Fi(),a={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;void 0!==u&&(a.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(a.useFetchStreams=!0),this.Oo(a.initMessageHeaders,t,n),a.encodeInitMessageHeaders=!0;const c=i.join("");Hi(Nc,`Creating RPC '${e}' stream ${r}: ${c}`,a);const l=s.createWebChannel(c,a);let h=!1,d=!1;const f=new Rc({Io:t=>{d?Hi(Nc,`Not sending because RPC '${e}' stream ${r} is closed:`,t):(h||(Hi(Nc,`Opening RPC '${e}' stream ${r} transport.`),l.open(),h=!0),Hi(Nc,`RPC '${e}' stream ${r} sending:`,t),l.send(t))},To:()=>l.close()}),p=(e,t,n)=>{e.listen(t,e=>{try{n(e)}catch(t){setTimeout(()=>{throw t},0)}})};return p(l,Pi.EventType.OPEN,()=>{d||(Hi(Nc,`RPC '${e}' stream ${r} transport opened.`),f.yo())}),p(l,Pi.EventType.CLOSE,()=>{d||(d=!0,Hi(Nc,`RPC '${e}' stream ${r} transport closed`),f.So())}),p(l,Pi.EventType.ERROR,t=>{d||(d=!0,Wi(Nc,`RPC '${e}' stream ${r} transport errored:`,t),f.So(new es(Zi.UNAVAILABLE,"The operation could not be completed")))}),p(l,Pi.EventType.MESSAGE,t=>{var n;if(!d){const i=t.data[0];Ji(!!i);const s=i,o=s.error||(null===(n=s[0])||void 0===n?void 0:n.error);if(o){Hi(Nc,`RPC '${e}' stream ${r} received error:`,o);const t=o.status;let n=function(e){const t=Ya[e];if(void 0!==t)return eu(t)}(t),i=o.message;void 0===n&&(n=Zi.INTERNAL,i="Unknown error status: "+t+" with message "+o.message),d=!0,f.So(new es(n,i)),l.close()}else Hi(Nc,`RPC '${e}' stream ${r} received:`,i),f.bo(i)}}),p(o,Ui.STAT_EVENT,t=>{t.stat===Mi.PROXY?Hi(Nc,`RPC '${e}' stream ${r} detected buffering proxy`):t.stat===Mi.NOPROXY&&Hi(Nc,`RPC '${e}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{f.wo()},0),f}}function Dc(){return"undefined"!=typeof document?document:null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class Sd{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class Cd extends od{constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new kd(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(ud("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class kd extends Cd{data(e={}){return super.data(e)}}class Ad{constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new Sd(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(n=>{e.call(t,new kd(this._firestore,this._userDataWriter,n.key,n,new Sd(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new es(Zi.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(n=>{const r=new kd(e._firestore,e._userDataWriter,n.doc.key,n.doc,new Sd(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:t++}})}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{const r=new kd(e._firestore,e._userDataWriter,t.doc.key,t.doc,new Sd(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter);let i=-1,s=-1;return 0!==t.type&&(i=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(n=n.add(t.doc),s=n.indexOf(t.doc.key)),{type:Rd(t.type),doc:r,oldIndex:i,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function Rd(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Xi()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nd(e){e=wh(e,Sh);const t=wh(e.firestore,Oh);return function(e,t,n={}){const r=new ts;return e.asyncQueue.enqueueAndForget(()=>l(this,null,function*(){return function(e,t,n,r,i){const s=new ah({next:a=>{s.Za(),t.enqueueAndForget(()=>Il(e,o));const u=a.docs.has(n);!u&&a.fromCache?i.reject(new es(Zi.UNAVAILABLE,"Failed to get document because the client is offline.")):u&&a.fromCache&&r&&"server"===r.source?i.reject(new es(Zi.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(a)},error:e=>i.reject(e)}),o=new Nl($o(n.path),s,{includeMetadataChanges:!0,_a:!0});return El(e,o)}(yield dh(e),e.asyncQueue,t,n,r)})),r.promise}(Ph(t),e._key).then(n=>Vd(t,e,n))}class Od extends Ed{constructor(e){super(),this.firestore=e}convertBytes(e){return new Lh(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Sh(this.firestore,null,t)}}function Dd(e){e=wh(e,Ih);const t=wh(e.firestore,Oh),n=Ph(t),r=new Od(t);return cd(e._query),function(e,t,n={}){const r=new ts;return e.asyncQueue.enqueueAndForget(()=>l(this,null,function*(){return function(e,t,n,r,i){const s=new ah({next:n=>{s.Za(),t.enqueueAndForget(()=>Il(e,o)),n.fromCache&&"server"===r.source?i.reject(new es(Zi.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),o=new Nl(n,s,{includeMetadataChanges:!0,_a:!0});return El(e,o)}(yield dh(e),e.asyncQueue,t,n,r)})),r.promise}(n,e._query).then(n=>new Ad(t,r,e,n))}function Pd(e,t,n){e=wh(e,Sh);const r=wh(e.firestore,Oh),i=Id(e.converter,t,n);return Fd(r,[Hh(Kh(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,Pa.none())])}function Ld(e,t,n,...r){e=wh(e,Sh);const i=wh(e.firestore,Oh),s=Kh(i);let o;return o="string"==typeof(t=U(t))||t instanceof xh?Xh(s,"updateDoc",e._key,t,n,r):Qh(s,"updateDoc",e._key,t),Fd(i,[o.toMutation(e._key,Pa.exists(!0))])}function xd(e){return Fd(wh(e.firestore,Oh),[new Ha(e._key,Pa.none())])}function Md(e,t){const n=wh(e.firestore,Oh),r=Ah(e),i=Id(e.converter,t);return Fd(n,[Hh(Kh(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,Pa.exists(!1))]).then(()=>r)}function Ud(e,...t){var n,r,i;e=U(e);let s={includeMetadataChanges:!1,source:"default"},o=0;"object"!=typeof t[o]||Nh(t[o])||(s=t[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Nh(t[o])){const e=t[o];t[o]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[o+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[o+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let u,c,h;if(e instanceof Sh)c=wh(e.firestore,Oh),h=$o(e._key.path),u={next:n=>{t[o]&&t[o](Vd(c,e,n))},error:t[o+1],complete:t[o+2]};else{const n=wh(e,Ih);c=wh(n.firestore,Oh),h=n._query;const r=new Od(c);u={next:e=>{t[o]&&t[o](new Ad(c,r,n,e))},error:t[o+1],complete:t[o+2]},cd(e._query)}return function(e,t,n,r){const i=new ah(r),s=new Nl(t,i,n);return e.asyncQueue.enqueueAndForget(()=>l(this,null,function*(){return El(yield dh(e),s)})),()=>{i.Za(),e.asyncQueue.enqueueAndForget(()=>l(this,null,function*(){return Il(yield dh(e),s)}))}}(Ph(c),h,a,u)}function Fd(e,t){return function(e,t){const n=new ts;return e.asyncQueue.enqueueAndForget(()=>l(this,null,function*(){return ql(yield function(e){return hh(e).then(e=>e.syncEngine)}(e),t,n)})),n.promise}(Ph(e),t)}function Vd(e,t,n){const r=n.docs.get(t._key),i=new Od(e);return new Cd(e,i,t._key,r,new Sd(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bd{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=Kh(e)}set(e,t,n){this._verifyNotCommitted();const r=jd(e,this._firestore),i=Id(r.converter,t,n),s=Hh(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(s.toMutation(r._key,Pa.none())),this}update(e,t,n,...r){this._verifyNotCommitted();const i=jd(e,this._firestore);let s;return s="string"==typeof(t=U(t))||t instanceof xh?Xh(this._dataReader,"WriteBatch.update",i._key,t,n,r):Qh(this._dataReader,"WriteBatch.update",i._key,t),this._mutations.push(s.toMutation(i._key,Pa.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=jd(e,this._firestore);return this._mutations=this._mutations.concat(new Ha(t._key,Pa.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new es(Zi.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function jd(e,t){if((e=U(e)).firestore!==t)throw new es(Zi.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}function qd(){return new Wh("serverTimestamp")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zd(e){return Ph(e=wh(e,Oh)),new Bd(e,t=>Fd(e,t))}!function(e,t=!0){zi=Ye,Ge(new F("firestore",(e,{instanceIdentifier:n,options:r})=>{const i=e.getProvider("app").getImmediate(),s=new Oh(new ss(e.getProvider("auth-internal")),new cs(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new es(Zi.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Xs(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:t},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),tt(ji,"4.7.3",e),tt(ji,"4.7.3","esm2017")}();const $d=Object.freeze(Object.defineProperty({__proto__:null,AbstractUserDataWriter:Ed,Bytes:Lh,CollectionReference:Ch,DocumentReference:Sh,DocumentSnapshot:Cd,FieldPath:xh,FieldValue:Mh,Firestore:Oh,FirestoreError:es,GeoPoint:Uh,Query:Ih,QueryCompositeFilterConstraint:gd,QueryConstraint:hd,QueryDocumentSnapshot:kd,QueryFieldFilterConstraint:fd,QueryLimitConstraint:vd,QueryOrderByConstraint:md,QuerySnapshot:Ad,SnapshotMetadata:Sd,Timestamp:ps,VectorValue:Fh,WriteBatch:Bd,_AutoId:hs,_ByteString:js,_DatabaseId:Xs,_DocumentKey:ws,_EmptyAuthCredentialsProvider:rs,_FieldPath:_s,_cast:wh,_logWarn:Wi,_validateIsNotUsedTogether:mh,addDoc:Md,collection:kh,connectFirestoreEmulator:Eh,deleteDoc:xd,doc:Ah,ensureFirestoreConfigured:Ph,executeWrite:Fd,getDoc:Nd,getDocs:Dd,getFirestore:Dh,limit:_d,onSnapshot:Ud,orderBy:yd,query:dd,serverTimestamp:qd,setDoc:Pd,updateDoc:Ld,where:pd,writeBatch:zd},Symbol.toStringTag,{value:"Module"})),Kd="firebasestorage.googleapis.com",Hd="storageBucket";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Gd extends k{constructor(e,t,n=0){super(Yd(e),`Firebase Storage: ${t} (${Yd(e)})`),this.status_=n,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,Gd.prototype)}get status(){return this.status_}set status(e){this.status_=e}_codeEquals(e){return Yd(e)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(e){this.customData.serverResponse=e,this.customData.serverResponse?this.message=`${this._baseMessage}\n${this.customData.serverResponse}`:this.message=this._baseMessage}}var Wd,Qd,Xd,Jd;function Yd(e){return"storage/"+e}function Zd(){return new Gd(Wd.UNKNOWN,"An unknown error occurred, please check the error payload for server response.")}function ef(){return new Gd(Wd.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function tf(){return new Gd(Wd.CANCELED,"User canceled the upload/download.")}function nf(){return new Gd(Wd.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function rf(e){return new Gd(Wd.INVALID_ARGUMENT,e)}function sf(){return new Gd(Wd.APP_DELETED,"The Firebase app was deleted.")}function of(e){return new Gd(Wd.INVALID_ROOT_OPERATION,"The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function af(e,t){return new Gd(Wd.INVALID_FORMAT,"String does not match format '"+e+"': "+t)}function uf(e){throw new Gd(Wd.INTERNAL_ERROR,"Internal error: "+e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Qd=Wd||(Wd={})).UNKNOWN="unknown",Qd.OBJECT_NOT_FOUND="object-not-found",Qd.BUCKET_NOT_FOUND="bucket-not-found",Qd.PROJECT_NOT_FOUND="project-not-found",Qd.QUOTA_EXCEEDED="quota-exceeded",Qd.UNAUTHENTICATED="unauthenticated",Qd.UNAUTHORIZED="unauthorized",Qd.UNAUTHORIZED_APP="unauthorized-app",Qd.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",Qd.INVALID_CHECKSUM="invalid-checksum",Qd.CANCELED="canceled",Qd.INVALID_EVENT_NAME="invalid-event-name",Qd.INVALID_URL="invalid-url",Qd.INVALID_DEFAULT_BUCKET="invalid-default-bucket",Qd.NO_DEFAULT_BUCKET="no-default-bucket",Qd.CANNOT_SLICE_BLOB="cannot-slice-blob",Qd.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",Qd.NO_DOWNLOAD_URL="no-download-url",Qd.INVALID_ARGUMENT="invalid-argument",Qd.INVALID_ARGUMENT_COUNT="invalid-argument-count",Qd.APP_DELETED="app-deleted",Qd.INVALID_ROOT_OPERATION="invalid-root-operation",Qd.INVALID_FORMAT="invalid-format",Qd.INTERNAL_ERROR="internal-error",Qd.UNSUPPORTED_ENVIRONMENT="unsupported-environment";class cf{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return 0===this.path.length}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let n;try{n=cf.makeFromUrl(e,t)}catch(i){return new cf(e,"")}if(""===n.path)return n;throw r=e,new Gd(Wd.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+r+"'.");var r}static makeFromUrl(e,t){let n=null;const r="([A-Za-z0-9.\\-_]+)";const i=new RegExp("^gs://"+r+"(/(.*))?$","i");function s(e){e.path_=decodeURIComponent(e.path)}const o=t.replace(/[.]/g,"\\."),a=[{regex:i,indices:{bucket:1,path:3},postModify:function(e){"/"===e.path.charAt(e.path.length-1)&&(e.path_=e.path_.slice(0,-1))}},{regex:new RegExp(`^https?://${o}/v[A-Za-z0-9_]+/b/${r}/o(/([^?#]*).*)?$`,"i"),indices:{bucket:1,path:3},postModify:s},{regex:new RegExp(`^https?://${t===Kd?"(?:storage.googleapis.com|storage.cloud.google.com)":t}/${r}/([^?#]*)`,"i"),indices:{bucket:1,path:2},postModify:s}];for(let u=0;u<a.length;u++){const t=a[u],r=t.regex.exec(e);if(r){const e=r[t.indices.bucket];let i=r[t.indices.path];i||(i=""),n=new cf(e,i),t.postModify(n);break}}if(null==n)throw function(e){return new Gd(Wd.INVALID_URL,"Invalid URL '"+e+"'.")}(e);return n}}class lf{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hf(e){return"string"==typeof e||e instanceof String}function df(e){return ff()&&e instanceof Blob}function ff(){return"undefined"!=typeof Blob}function pf(e,t,n,r){if(r<t)throw rf(`Invalid value for '${e}'. Expected ${t} or greater.`);if(r>n)throw rf(`Invalid value for '${e}'. Expected ${n} or less.`)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gf(e,t,n){let r=t;return null==n&&(r=`https://${t}`),`${n}://${r}/v0${e}`}function mf(e){const t=encodeURIComponent;let n="?";for(const r in e)if(e.hasOwnProperty(r)){n=n+(t(r)+"="+t(e[r]))+"&"}return n=n.slice(0,-1),n}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
function yf(e,t){const n=e>=500&&e<600,r=-1!==[408,429].indexOf(e),i=-1!==t.indexOf(e);return n||r||i}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Jd=Xd||(Xd={}))[Jd.NO_ERROR=0]="NO_ERROR",Jd[Jd.NETWORK_ERROR=1]="NETWORK_ERROR",Jd[Jd.ABORT=2]="ABORT";class vf{constructor(e,t,n,r,i,s,o,a,u,c,l,h=!0){this.url_=e,this.method_=t,this.headers_=n,this.body_=r,this.successCodes_=i,this.additionalRetryCodes_=s,this.callback_=o,this.errorCallback_=a,this.timeout_=u,this.progressCallback_=c,this.connectionFactory_=l,this.retry=h,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((e,t)=>{this.resolve_=e,this.reject_=t,this.start_()})}start_(){const e=(e,t)=>{if(t)return void e(!1,new _f(!1,null,!0));const n=this.connectionFactory_();this.pendingConnection_=n;const r=e=>{const t=e.loaded,n=e.lengthComputable?e.total:-1;null!==this.progressCallback_&&this.progressCallback_(t,n)};null!==this.progressCallback_&&n.addUploadProgressListener(r),n.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{null!==this.progressCallback_&&n.removeUploadProgressListener(r),this.pendingConnection_=null;const t=n.getErrorCode()===Xd.NO_ERROR,i=n.getStatus();if(!t||yf(i,this.additionalRetryCodes_)&&this.retry){const t=n.getErrorCode()===Xd.ABORT;return void e(!1,new _f(!1,null,t))}const s=-1!==this.successCodes_.indexOf(i);e(!0,new _f(s,n))})},t=(e,t)=>{const n=this.resolve_,r=this.reject_,i=t.connection;if(t.wasSuccessCode)try{const e=this.callback_(i,i.getResponse());!
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){return void 0!==e}(e)?n():n(e)}catch(s){r(s)}else if(null!==i){const e=Zd();e.serverResponse=i.getErrorText(),this.errorCallback_?r(this.errorCallback_(i,e)):r(e)}else if(t.canceled){r(this.appDelete_?sf():tf())}else{r(ef())}};this.canceled_?t(0,new _f(!1,null,!0)):this.backoffId_=function(e,t,n){let r=1,i=null,s=null,o=!1,a=0;function u(){return 2===a}let c=!1;function l(...e){c||(c=!0,t.apply(null,e))}function h(t){i=setTimeout(()=>{i=null,e(f,u())},t)}function d(){s&&clearTimeout(s)}function f(e,...t){if(c)return void d();if(e)return d(),void l.call(null,e,...t);if(u()||o)return d(),void l.call(null,e,...t);let n;r<64&&(r*=2),1===a?(a=2,n=0):n=1e3*(r+Math.random()),h(n)}let p=!1;function g(e){p||(p=!0,d(),c||(null!==i?(e||(a=2),clearTimeout(i),h(0)):e||(a=1)))}return h(0),s=setTimeout(()=>{o=!0,g(!0)},n),g}(e,t,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,null!==this.backoffId_&&(0,this.backoffId_)(!1),null!==this.pendingConnection_&&this.pendingConnection_.abort()}}class _f{constructor(e,t,n){this.wasSuccessCode=e,this.connection=t,this.canceled=!!n}}function wf(...e){const t="undefined"!=typeof BlobBuilder?BlobBuilder:"undefined"!=typeof WebKitBlobBuilder?WebKitBlobBuilder:void 0;if(void 0!==t){const n=new t;for(let t=0;t<e.length;t++)n.append(e[t]);return n.getBlob()}if(ff())return new Blob(e);throw new Gd(Wd.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Tf(e){if("undefined"==typeof atob)throw t="base-64",new Gd(Wd.UNSUPPORTED_ENVIRONMENT,`${t} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`);var t;return atob(e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bf={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Ef{constructor(e,t){this.data=e,this.contentType=t||null}}function If(e,t){switch(e){case bf.RAW:return new Ef(Sf(t));case bf.BASE64:case bf.BASE64URL:return new Ef(Cf(e,t));case bf.DATA_URL:return new Ef(function(e){const t=new kf(e);return t.base64?Cf(bf.BASE64,t.rest):function(e){let t;try{t=decodeURIComponent(e)}catch(n){throw af(bf.DATA_URL,"Malformed data URL.")}return Sf(t)}(t.rest)}(t),new kf(t).contentType)}throw Zd()}function Sf(e){const t=[];for(let n=0;n<e.length;n++){let r=e.charCodeAt(n);if(r<=127)t.push(r);else if(r<=2047)t.push(192|r>>6,128|63&r);else if(55296==(64512&r)){if(n<e.length-1&&56320==(64512&e.charCodeAt(n+1))){r=65536|(1023&r)<<10|1023&e.charCodeAt(++n),t.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|63&r)}else t.push(239,191,189)}else 56320==(64512&r)?t.push(239,191,189):t.push(224|r>>12,128|r>>6&63,128|63&r)}return new Uint8Array(t)}function Cf(e,t){switch(e){case bf.BASE64:{const n=-1!==t.indexOf("-"),r=-1!==t.indexOf("_");if(n||r){throw af(e,"Invalid character '"+(n?"-":"_")+"' found: is it base64url encoded?")}break}case bf.BASE64URL:{const n=-1!==t.indexOf("+"),r=-1!==t.indexOf("/");if(n||r){throw af(e,"Invalid character '"+(n?"+":"/")+"' found: is it base64 encoded?")}t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=Tf(t)}catch(i){if(i.message.includes("polyfill"))throw i;throw af(e,"Invalid character found")}const r=new Uint8Array(n.length);for(let s=0;s<n.length;s++)r[s]=n.charCodeAt(s);return r}class kf{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(null===t)throw af(bf.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=t[1]||null;null!=n&&(this.base64=function(e,t){if(!(e.length>=t.length))return!1;return e.substring(e.length-t.length)===t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n,";base64"),this.contentType=this.base64?n.substring(0,n.length-7):n),this.rest=e.substring(e.indexOf(",")+1)}}class Af{constructor(e,t){let n=0,r="";df(e)?(this.data_=e,n=e.size,r=e.type):e instanceof ArrayBuffer?(t?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),n=this.data_.length):e instanceof Uint8Array&&(t?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),n=e.length),this.size_=n,this.type_=r}size(){return this.size_}type(){return this.type_}slice(e,t){if(df(this.data_)){const s=this.data_,o=(r=e,i=t,(n=s).webkitSlice?n.webkitSlice(r,i):n.mozSlice?n.mozSlice(r,i):n.slice?n.slice(r,i):null);return null===o?null:new Af(o)}{const n=new Uint8Array(this.data_.buffer,e,t-e);return new Af(n,!0)}var n,r,i}static getBlob(...e){if(ff()){const t=e.map(e=>e instanceof Af?e.data_:e);return new Af(wf.apply(null,t))}{const t=e.map(e=>hf(e)?If(bf.RAW,e).data:e.data_);let n=0;t.forEach(e=>{n+=e.byteLength});const r=new Uint8Array(n);let i=0;return t.forEach(e=>{for(let t=0;t<e.length;t++)r[i++]=e[t]}),new Af(r,!0)}}uploadData(){return this.data_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rf(e){let t;try{t=JSON.parse(e)}catch(n){return null}return function(e){return"object"==typeof e&&!Array.isArray(e)}(t)?t:null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nf(e){const t=e.lastIndexOf("/",e.length-2);return-1===t?e:e.slice(t+1)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Of(e,t){return t}class Df{constructor(e,t,n,r){this.server=e,this.local=t||e,this.writable=!!n,this.xform=r||Of}}let Pf=null;function Lf(){if(Pf)return Pf;const e=[];e.push(new Df("bucket")),e.push(new Df("generation")),e.push(new Df("metageneration")),e.push(new Df("name","fullPath",!0));const t=new Df("name");t.xform=function(e,t){return function(e){return!hf(e)||e.length<2?e:Nf(e)}(t)},e.push(t);const n=new Df("size");return n.xform=function(e,t){return void 0!==t?Number(t):t},e.push(n),e.push(new Df("timeCreated")),e.push(new Df("updated")),e.push(new Df("md5Hash",null,!0)),e.push(new Df("cacheControl",null,!0)),e.push(new Df("contentDisposition",null,!0)),e.push(new Df("contentEncoding",null,!0)),e.push(new Df("contentLanguage",null,!0)),e.push(new Df("contentType",null,!0)),e.push(new Df("metadata","customMetadata",!0)),Pf=e,Pf}function xf(e,t,n){const r={type:"file"},i=n.length;for(let s=0;s<i;s++){const e=n[s];r[e.local]=e.xform(r,t[e.server])}return function(e,t){Object.defineProperty(e,"ref",{get:function(){const n=e.bucket,r=e.fullPath,i=new cf(n,r);return t._makeStorageReference(i)}})}(r,e),r}function Mf(e,t,n){const r=Rf(t);if(null===r)return null;return xf(e,r,n)}function Uf(e,t){const n={},r=t.length;for(let i=0;i<r;i++){const r=t[i];r.writable&&(n[r.server]=e[r.local])}return JSON.stringify(n)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ff="prefixes",Vf="items";function Bf(e,t,n){const r=Rf(n);if(null===r)return null;return function(e,t,n){const r={prefixes:[],items:[],nextPageToken:n.nextPageToken};if(n[Ff])for(const i of n[Ff]){const n=i.replace(/\/$/,""),s=e._makeStorageReference(new cf(t,n));r.prefixes.push(s)}if(n[Vf])for(const i of n[Vf]){const n=e._makeStorageReference(new cf(t,i.name));r.items.push(n)}return r}(e,t,r)}class jf{constructor(e,t,n,r){this.url=e,this.method=t,this.handler=n,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qf(e){if(!e)throw Zd()}function zf(e,t){return function(n,r){const i=Mf(e,r,t);return qf(null!==i),i}}function $f(e,t){return function(n,r){const i=Mf(e,r,t);return qf(null!==i),function(e,t,n,r){const i=Rf(t);if(null===i)return null;if(!hf(i.downloadTokens))return null;const s=i.downloadTokens;if(0===s.length)return null;const o=encodeURIComponent;return s.split(",").map(t=>{const i=e.bucket,s=e.fullPath;return gf("/b/"+o(i)+"/o/"+o(s),n,r)+mf({alt:"media",token:t})})[0]}(i,r,e.host,e._protocol)}}function Kf(e){return function(t,n){let r;var i,s;return 401===t.getStatus()?r=t.getErrorText().includes("Firebase App Check token is invalid")?new Gd(Wd.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project."):new Gd(Wd.UNAUTHENTICATED,"User is not authenticated, please authenticate using Firebase Authentication and try again."):402===t.getStatus()?(s=e.bucket,r=new Gd(Wd.QUOTA_EXCEEDED,"Quota for bucket '"+s+"' exceeded, please view quota on https://firebase.google.com/pricing/.")):403===t.getStatus()?(i=e.path,r=new Gd(Wd.UNAUTHORIZED,"User does not have permission to access '"+i+"'.")):r=n,r.status=t.getStatus(),r.serverResponse=n.serverResponse,r}}function Hf(e){const t=Kf(e);return function(n,r){let i=t(n,r);var s;return 404===n.getStatus()&&(s=e.path,i=new Gd(Wd.OBJECT_NOT_FOUND,"Object '"+s+"' does not exist.")),i.serverResponse=r.serverResponse,i}}function Gf(e,t,n){const r=gf(t.fullServerUrl(),e.host,e._protocol),i=e.maxOperationRetryTime,s=new jf(r,"GET",zf(e,n),i);return s.errorHandler=Hf(t),s}function Wf(e,t,n,r,i){const s={};t.isRoot?s.prefix="":s.prefix=t.path+"/",n.length>0&&(s.delimiter=n),r&&(s.pageToken=r),i&&(s.maxResults=i);const o=gf(t.bucketOnlyServerUrl(),e.host,e._protocol),a=e.maxOperationRetryTime,u=new jf(o,"GET",function(e,t){return function(n,r){const i=Bf(e,t,r);return qf(null!==i),i}}(e,t.bucket),a);return u.urlParams=s,u.errorHandler=Kf(t),u}function Qf(e,t,n){const r=Object.assign({},n);return r.fullPath=e.path,r.size=t.size(),r.contentType||(r.contentType=function(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}(null,t)),r}function Xf(e,t,n,r,i){const s=t.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};const a=function(){let e="";for(let t=0;t<2;t++)e+=Math.random().toString().slice(2);return e}();o["Content-Type"]="multipart/related; boundary="+a;const u=Qf(t,r,i),c="--"+a+"\r\nContent-Type: application/json; charset=utf-8\r\n\r\n"+Uf(u,n)+"\r\n--"+a+"\r\nContent-Type: "+u.contentType+"\r\n\r\n",l="\r\n--"+a+"--",h=Af.getBlob(c,r,l);if(null===h)throw nf();const d={name:u.fullPath},f=gf(s,e.host,e._protocol),p=e.maxUploadRetryTime,g=new jf(f,"POST",zf(e,n),p);return g.urlParams=d,g.headers=o,g.body=h.uploadData(),g.errorHandler=Kf(t),g}class Jf{constructor(e,t,n,r){this.current=e,this.total=t,this.finalized=!!n,this.metadata=r||null}}function Yf(e,t){let n=null;try{n=e.getResponseHeader("X-Goog-Upload-Status")}catch(r){qf(!1)}return qf(!!n&&-1!==(t||["active"]).indexOf(n)),n}const Zf=262144;function ep(e,t,n,r,i,s,o,a){const u=new Jf(0,0);if(o?(u.current=o.current,u.total=o.total):(u.current=0,u.total=r.size()),r.size()!==u.total)throw new Gd(Wd.SERVER_FILE_WRONG_SIZE,"Server recorded incorrect upload file size, please retry the upload.");const c=u.total-u.current;let l=c;i>0&&(l=Math.min(l,i));const h=u.current,d=h+l;let f="";f=0===l?"finalize":c===l?"upload, finalize":"upload";const p={"X-Goog-Upload-Command":f,"X-Goog-Upload-Offset":`${u.current}`},g=r.slice(h,d);if(null===g)throw nf();const m=t.maxUploadRetryTime,y=new jf(n,"POST",function(e,n){const i=Yf(e,["active","final"]),o=u.current+l,a=r.size();let c;return c="final"===i?zf(t,s)(e,n):null,new Jf(o,a,"final"===i,c)},m);return y.headers=p,y.body=g.uploadData(),y.progressCallback=a||null,y.errorHandler=Kf(e),y}const tp={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function np(e){switch(e){case"running":case"pausing":case"canceling":return tp.RUNNING;case"paused":return tp.PAUSED;case"success":return tp.SUCCESS;case"canceled":return tp.CANCELED;default:return tp.ERROR}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rp{constructor(e,t,n){const r=function(e){return"function"==typeof e}(e)||null!=t||null!=n;if(r)this.next=e,this.error=null!=t?t:void 0,this.complete=null!=n?n:void 0;else{const t=e;this.next=t.next,this.error=t.error,this.complete=t.complete}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class up{constructor(e,t,n=null){this._transferred=0,this._needToFetchStatus=!1,this._needToFetchMetadata=!1,this._observers=[],this._error=void 0,this._uploadUrl=void 0,this._request=void 0,this._chunkMultiplier=1,this._resolve=void 0,this._reject=void 0,this._ref=e,this._blob=t,this._metadata=n,this._mappings=Lf(),this._resumable=this._shouldDoResumable(this._blob),this._state="running",this._errorHandler=e=>{if(this._request=void 0,this._chunkMultiplier=1,e._codeEquals(Wd.CANCELED))this._needToFetchStatus=!0,this.completeTransitions_();else{const t=this.isExponentialBackoffExpired();if(yf(e.status,[])){if(!t)return this.sleepTime=Math.max(2*this.sleepTime,1e3),this._needToFetchStatus=!0,void this.completeTransitions_();e=ef()}this._error=e,this._transition("error")}},this._metadataErrorHandler=e=>{this._request=void 0,e._codeEquals(Wd.CANCELED)?this.completeTransitions_():(this._error=e,this._transition("error"))},this.sleepTime=0,this.maxSleepTime=this._ref.storage.maxUploadRetryTime,this._promise=new Promise((e,t)=>{this._resolve=e,this._reject=t,this._start()}),this._promise.then(null,()=>{})}isExponentialBackoffExpired(){return this.sleepTime>this.maxSleepTime}_makeProgressCallback(){const e=this._transferred;return t=>this._updateProgress(e+t)}_shouldDoResumable(e){return e.size()>262144}_start(){"running"===this._state&&void 0===this._request&&(this._resumable?void 0===this._uploadUrl?this._createResumable():this._needToFetchStatus?this._fetchStatus():this._needToFetchMetadata?this._fetchMetadata():this.pendingTimeout=setTimeout(()=>{this.pendingTimeout=void 0,this._continueUpload()},this.sleepTime):this._oneShotUpload())}_resolveToken(e){Promise.all([this._ref.storage._getAuthToken(),this._ref.storage._getAppCheckToken()]).then(([t,n])=>{switch(this._state){case"running":e(t,n);break;case"canceling":this._transition("canceled");break;case"pausing":this._transition("paused")}})}_createResumable(){this._resolveToken((e,t)=>{const n=function(e,t,n,r,i){const s=t.bucketOnlyServerUrl(),o=Qf(t,r,i),a={name:o.fullPath},u=gf(s,e.host,e._protocol),c={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},l=Uf(o,n),h=e.maxUploadRetryTime,d=new jf(u,"POST",function(e){let t;Yf(e);try{t=e.getResponseHeader("X-Goog-Upload-URL")}catch(n){qf(!1)}return qf(hf(t)),t},h);return d.urlParams=a,d.headers=c,d.body=l,d.errorHandler=Kf(t),d}(this._ref.storage,this._ref._location,this._mappings,this._blob,this._metadata),r=this._ref.storage._makeRequest(n,ap,e,t);this._request=r,r.getPromise().then(e=>{this._request=void 0,this._uploadUrl=e,this._needToFetchStatus=!1,this.completeTransitions_()},this._errorHandler)})}_fetchStatus(){const e=this._uploadUrl;this._resolveToken((t,n)=>{const r=function(e,t,n,r){const i=e.maxUploadRetryTime,s=new jf(n,"POST",function(e){const t=Yf(e,["active","final"]);let n=null;try{n=e.getResponseHeader("X-Goog-Upload-Size-Received")}catch(s){qf(!1)}n||qf(!1);const i=Number(n);return qf(!isNaN(i)),new Jf(i,r.size(),"final"===t)},i);return s.headers={"X-Goog-Upload-Command":"query"},s.errorHandler=Kf(t),s}(this._ref.storage,this._ref._location,e,this._blob),i=this._ref.storage._makeRequest(r,ap,t,n);this._request=i,i.getPromise().then(e=>{this._request=void 0,this._updateProgress(e.current),this._needToFetchStatus=!1,e.finalized&&(this._needToFetchMetadata=!0),this.completeTransitions_()},this._errorHandler)})}_continueUpload(){const e=Zf*this._chunkMultiplier,t=new Jf(this._transferred,this._blob.size()),n=this._uploadUrl;this._resolveToken((r,i)=>{let s;try{s=ep(this._ref._location,this._ref.storage,n,this._blob,e,this._mappings,t,this._makeProgressCallback())}catch(a){return this._error=a,void this._transition("error")}const o=this._ref.storage._makeRequest(s,ap,r,i,!1);this._request=o,o.getPromise().then(e=>{this._increaseMultiplier(),this._request=void 0,this._updateProgress(e.current),e.finalized?(this._metadata=e.metadata,this._transition("success")):this.completeTransitions_()},this._errorHandler)})}_increaseMultiplier(){2*(Zf*this._chunkMultiplier)<33554432&&(this._chunkMultiplier*=2)}_fetchMetadata(){this._resolveToken((e,t)=>{const n=Gf(this._ref.storage,this._ref._location,this._mappings),r=this._ref.storage._makeRequest(n,ap,e,t);this._request=r,r.getPromise().then(e=>{this._request=void 0,this._metadata=e,this._transition("success")},this._metadataErrorHandler)})}_oneShotUpload(){this._resolveToken((e,t)=>{const n=Xf(this._ref.storage,this._ref._location,this._mappings,this._blob,this._metadata),r=this._ref.storage._makeRequest(n,ap,e,t);this._request=r,r.getPromise().then(e=>{this._request=void 0,this._metadata=e,this._updateProgress(this._blob.size()),this._transition("success")},this._errorHandler)})}_updateProgress(e){const t=this._transferred;this._transferred=e,this._transferred!==t&&this._notifyObservers()}_transition(e){if(this._state!==e)switch(e){case"canceling":case"pausing":this._state=e,void 0!==this._request?this._request.cancel():this.pendingTimeout&&(clearTimeout(this.pendingTimeout),this.pendingTimeout=void 0,this.completeTransitions_());break;case"running":const t="paused"===this._state;this._state=e,t&&(this._notifyObservers(),this._start());break;case"paused":case"error":case"success":this._state=e,this._notifyObservers();break;case"canceled":this._error=tf(),this._state=e,this._notifyObservers()}}completeTransitions_(){switch(this._state){case"pausing":this._transition("paused");break;case"canceling":this._transition("canceled");break;case"running":this._start()}}get snapshot(){const e=np(this._state);return{bytesTransferred:this._transferred,totalBytes:this._blob.size(),state:e,metadata:this._metadata,task:this,ref:this._ref}}on(e,t,n,r){const i=new rp(t||void 0,n||void 0,r||void 0);return this._addObserver(i),()=>{this._removeObserver(i)}}then(e,t){return this._promise.then(e,t)}catch(e){return this.then(null,e)}_addObserver(e){this._observers.push(e),this._notifyObserver(e)}_removeObserver(e){const t=this._observers.indexOf(e);-1!==t&&this._observers.splice(t,1)}_notifyObservers(){this._finishPromise();this._observers.slice().forEach(e=>{this._notifyObserver(e)})}_finishPromise(){if(void 0!==this._resolve){let e=!0;switch(np(this._state)){case tp.SUCCESS:ip(this._resolve.bind(null,this.snapshot))();break;case tp.CANCELED:case tp.ERROR:ip(this._reject.bind(null,this._error))();break;default:e=!1}e&&(this._resolve=void 0,this._reject=void 0)}}_notifyObserver(e){switch(np(this._state)){case tp.RUNNING:case tp.PAUSED:e.next&&ip(e.next.bind(e,this.snapshot))();break;case tp.SUCCESS:e.complete&&ip(e.complete.bind(e))();break;default:e.error&&ip(e.error.bind(e,this._error))()}}resume(){const e="paused"===this._state||"pausing"===this._state;return e&&this._transition("running"),e}pause(){const e="running"===this._state;return e&&this._transition("pausing"),e}cancel(){const e="running"===this._state||"pausing"===this._state;return e&&this._transition("canceling"),e}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cp{constructor(e,t){this._service=e,this._location=t instanceof cf?t:cf.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new cp(e,t)}get root(){const e=new cf(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Nf(this._location.path)}get storage(){return this._service}get parent(){const e=function(e){if(0===e.length)return null;const t=e.lastIndexOf("/");return-1===t?"":e.slice(0,t)}(this._location.path);if(null===e)return null;const t=new cf(this._location.bucket,e);return new cp(this._service,t)}_throwIfRoot(e){if(""===this._location.path)throw of(e)}}function lp(e){const t={prefixes:[],items:[]};return hp(e,t).then(()=>t)}function hp(e,t,n){return l(this,null,function*(){const r={pageToken:n},i=yield function(e,t){null!=t&&"number"==typeof t.maxResults&&pf("options.maxResults",1,1e3,t.maxResults);const n=t||{},r=Wf(e.storage,e._location,"/",n.pageToken,n.maxResults);return e.storage.makeRequestWithTokens(r,ap)}(e,r);t.prefixes.push(...i.prefixes),t.items.push(...i.items),null!=i.nextPageToken&&(yield hp(e,t,i.nextPageToken))})}function dp(e){e._throwIfRoot("getDownloadURL");const t=function(e,t,n){const r=gf(t.fullServerUrl(),e.host,e._protocol),i=e.maxOperationRetryTime,s=new jf(r,"GET",$f(e,n),i);return s.errorHandler=Hf(t),s}(e.storage,e._location,Lf());return e.storage.makeRequestWithTokens(t,ap).then(e=>{if(null===e)throw new Gd(Wd.NO_DOWNLOAD_URL,"The given file does not have any download URLs.");return e})}function fp(e){e._throwIfRoot("deleteObject");const t=function(e,t){const n=gf(t.fullServerUrl(),e.host,e._protocol),r=e.maxOperationRetryTime,i=new jf(n,"DELETE",function(e,t){},r);return i.successCodes=[200,204],i.errorHandler=Hf(t),i}(e.storage,e._location);return e.storage.makeRequestWithTokens(t,ap)}function pp(e,t){if(e instanceof yp){const n=e;if(null==n._bucket)throw new Gd(Wd.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+Hd+"' property when initializing the app?");const r=new cp(n,n._bucket);return null!=t?pp(r,t):r}return void 0!==t?function(e,t){const n=function(e,t){const n=t.split("/").filter(e=>e.length>0).join("/");return 0===e.length?n:e+"/"+n}(e._location.path,t),r=new cf(e._location.bucket,n);return new cp(e.storage,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t):e}function gp(e,t){if(t&&/^[A-Za-z]+:\/\//.test(t)){if(e instanceof yp)return new cp(e,t);throw rf("To use ref(service, url), the first argument must be a Storage instance.")}return pp(e,t)}function mp(e,t){const n=null==t?void 0:t[Hd];return null==n?null:cf.makeFromBucketSpec(n,e)}class yp{constructor(e,t,n,r,i){this.app=e,this._authProvider=t,this._appCheckProvider=n,this._url=r,this._firebaseVersion=i,this._bucket=null,this._host=Kd,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=12e4,this._maxUploadRetryTime=6e5,this._requests=new Set,this._bucket=null!=r?cf.makeFromBucketSpec(r,this._host):mp(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,null!=this._url?this._bucket=cf.makeFromBucketSpec(this._url,e):this._bucket=mp(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){pf("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){pf("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}_getAuthToken(){return l(this,null,function*(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=yield e.getToken();if(null!==t)return t.accessToken}return null})}_getAppCheckToken(){return l(this,null,function*(){const e=this._appCheckProvider.getImmediate({optional:!0});if(e){return(yield e.getToken()).token}return null})}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new cp(this,e)}_makeRequest(e,t,n,r,i=!0){if(this._deleted)return new lf(sf());{const s=function(e,t,n,r,i,s,o=!0){const a=mf(e.urlParams),u=e.url+a,c=Object.assign({},e.headers);return function(e,t){t&&(e["X-Firebase-GMPID"]=t)}(c,t),function(e,t){null!==t&&t.length>0&&(e.Authorization="Firebase "+t)}(c,n),function(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(null!=t?t:"AppManager")}(c,s),function(e,t){null!==t&&(e["X-Firebase-AppCheck"]=t)}(c,r),new vf(u,e.method,c,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,i,o)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,this._appId,n,r,t,this._firebaseVersion,i);return this._requests.add(s),s.getPromise().then(()=>this._requests.delete(s),()=>this._requests.delete(s)),s}}makeRequestWithTokens(e,t){return l(this,null,function*(){const[n,r]=yield Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,n,r).getPromise()})}}const vp="@firebase/storage",_p="0.13.2",wp="storage";function Tp(e,t,n){return function(e,t,n){e._throwIfRoot("uploadBytes");const r=Xf(e.storage,e._location,Lf(),new Af(t,!0),n);return e.storage.makeRequestWithTokens(r,ap).then(t=>({metadata:t,ref:e}))}(e=U(e),t,n)}function bp(e,t,n){return function(e,t,n){return e._throwIfRoot("uploadBytesResumable"),new up(e,new Af(t),n)}(e=U(e),t,n)}function Ep(e){return function(e){e._throwIfRoot("getMetadata");const t=Gf(e.storage,e._location,Lf());return e.storage.makeRequestWithTokens(t,ap)}(e=U(e))}function Ip(e){return lp(e=U(e))}function Sp(e){return dp(e=U(e))}function Cp(e){return fp(e=U(e))}function kp(e,t){return gp(e=U(e),t)}function Ap(e=et(),t){const n=We(e=U(e),wp).getImmediate({identifier:t}),r=w("storage");return r&&Rp(n,...r),n}function Rp(e,t,n,r={}){!function(e,t,n,r={}){e.host=`${t}:${n}`,e._protocol="http";const{mockUserToken:i}=r;i&&(e._overrideAuthToken="string"==typeof i?i:I(i,e.app.options.projectId))}(e,t,n,r)}function Np(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return new yp(n,r,i,t,Ye)}Ge(new F(wp,Np,"PUBLIC").setMultipleInstances(!0)),tt(vp,_p,""),tt(vp,_p,"esm2017");const Op=Object.freeze(Object.defineProperty({__proto__:null,StorageError:Gd,get StorageErrorCode(){return Wd},StringFormat:bf,_FbsBlob:Af,_Location:cf,_TaskState:tp,_UploadTask:up,_dataFromString:If,_invalidArgument:rf,_invalidRootOperation:of,connectStorageEmulator:Rp,deleteObject:Cp,getDownloadURL:Sp,getMetadata:Ep,getStorage:Ap,listAll:Ip,ref:kp,uploadBytes:Tp,uploadBytesResumable:bp},Symbol.toStringTag,{value:"Module"}));export{_d as A,zd as B,Pd as C,Cp as D,Sp as E,Tp as F,Xn as G,bp as H,Ai as I,$d as J,Op as K,Ud as a,Md as b,kh as c,Ah as d,xd as e,Ep as f,Dd as g,Ci as h,Ze as i,Dh as j,Ap as k,Ip as l,fr as m,cr as n,yd as o,zr as p,dd as q,kp as r,qd as s,ur as t,Ld as u,lr as v,pd as w,pr as x,ar as y,Nd as z};
